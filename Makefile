test_linux_chrome_latest:
	robot  --variable platform:"linux" --variable browserName:Chrome --variable version:latest --variable visual:false --variable network:false --variable console:false Tests/*.robot

test_linux_firefox_latest:
	robot --variable platform:"linux" --variable browserName:Firefox --variable version:latest --variable visual:false --variable network:false --variable console:false Tests/*.robot
